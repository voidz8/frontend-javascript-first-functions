...
const getSchool = () => "Novi Hogeschool";
...
const compliment = () => "Lekker bezig met die functies, Jan!";
...
const getDetails = (firstName, lastName) => firstName + " " + lastName;

console.log(getDetails("Renzo", "Vermue"))
